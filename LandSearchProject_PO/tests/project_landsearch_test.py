...
class projectLandsearchTest:
    ...
    landing_page.landing_toggle_dark_mode()  # toggle dark mode
    ...
    result_page.result_toggle_dark_mode()  # toggle dark mode
    property_list = result_page.gather_properties_list()  # create property list
    csv_file_name = result_page.scrape_data_to_csv(property_list)  # scrape data to csv file
